...
/*----------------------------------------------------------------------------*/
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_RP_AdjustData_IoHwAb_DioReadChannelGroup( P2VAR(Dio_PortLevelType, AUTOMATIC, RTE_APPL_DATA) state );
#define Rte_Call_IoHwAb_DioReadChannelGroup Rte_Call_RP_AdjustData_IoHwAb_DioReadChannelGroup

extern FUNC(Std_ReturnType, RTE_CODE) Rte_Write_PP_PositionData_SendPosition( VAR(AUTOSAR_uint8, AUTOMATIC) data );
