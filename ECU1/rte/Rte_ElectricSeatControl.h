...
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_RP_MemorySeat_NvM_ReadCurrentPosition( P2(AUTOSAR_uint16, AUTOMATIC) NvM_DstPtr );
#define Rte_Call_RP_MemorySeat_NvM_ReadCurrentPosition  Rte_Call_NvM_ReadCurrentPosition

extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_RP_MemorySeat_NvM_ReadMode( P2(AUTOSAR_uint32, AUTOMATIC) NvM_DstPtr );
#define Rte_Call_RP_MemorySeat_NvM_ReadMode             Rte_Call_NvM_ReadMode

extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_RP_MemorySeat_NvM_WriteCurruntPosition( P2(AUTOSAR_uint16, AUTOMATIC) NvM_SrcPtr );
#define Rte_Call_RP_MemorySeat_NvM_WriteCurruntPosition Rte_Call_NvM_WriteCurruntPosition

extern FUNC(Std_ReturnType, RTE_CODE) Rte_Call_RP_MemorySeat_NvM_WriteMode( P2(AUTOSAR_uint32, AUTOMATIC) NvM_SrcPtr );
